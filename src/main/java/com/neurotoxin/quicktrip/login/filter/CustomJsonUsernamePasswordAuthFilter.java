package com.neurotoxin.quicktrip.login.filter;
 ...
 */
public class CustomJsonUsernamePasswordAuthFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public CustomJsonUsernamePasswordAuthFilter(ObjectMapper objectMapper) {
